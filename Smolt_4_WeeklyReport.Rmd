...
LastDet <- DF.Clean %>%
  ...
  left_join(Strain.0 %>% 
              mutate(TagID = substr(TagID, 6, 17)), by = "TagID") %>% 
...
### Fish at Dams
```{r Dams, echo=FALSE, warning = FALSE, message = FALSE, fig.align = 'center', out.width = '90%'}
