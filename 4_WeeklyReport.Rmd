...
for (i in 1:length(FilesGMT5a)){
  x1 <- read_fwf(paste("../RawReceiverDownloads/GMTPlus5/", FilesGMT5a[i], sep = ""),
                 fwf_empty(paste("../RawReceiverDownloads/GMTPlus5/", FilesGMT5a[i], sep = ""),
...
#   y1 <- read_fwf(paste("../RawReceiverDownloads/", FilesGMT4a[j], sep = ""),
#                  fwf_empty(paste("../RawReceiverDownloads/", FilesGMT4a[j], sep = ""),
#                            col_names = c("Date", "Time", "Site", "Ant", "Freq", 
#                                          "Type", "Code", "Power")),
#                  col_types = c(Date  = "D", Time = "t", Site = "d", Ant = "d",
#                                Freq = "c", Type = "c", Code = "d", Power = "d"),
